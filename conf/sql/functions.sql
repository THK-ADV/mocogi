...
CREATE OR REPLACE FUNCTION resolve_po_relationships (module_id uuid)
    ...
    SELECT
        ...
        coalesce((
            SELECT
                jsonb_agg(jsonb_build_object('poId', po.id, 'poVersion', po.version, 'poECTSFactor', po.ects_factor, 'studyProgramLabel', sp.de_label, 'studyProgramAbbreviation', sp.abbreviation, 'degree', deg.de_label, 'specialization', spec.label, 'recommendedSemester', mpm.recommended_semester))
        ...
        coalesce((
            SELECT
                jsonb_agg(jsonb_build_object('poId', po.id, 'poVersion', po.version, 'poECTSFactor', po.ects_factor, 'studyProgramLabel', sp.de_label, 'studyProgramAbbreviation', sp.abbreviation, 'degree', deg.de_label, 'specialization', spec.label, 'recommendedSemester', mpo.recommended_semester, 'instanceOf', module_to_json_short (inst_mod)))
