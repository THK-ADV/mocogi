...
// TODO remove? What is the difference to ModuleProtocol?
case class ModuleOutput(
    gitPath: String,
...
object ModuleOutput {
  implicit def writes: Writes[ModuleOutput] = Json.writes
}
