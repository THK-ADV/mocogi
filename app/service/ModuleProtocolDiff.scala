...
object ModuleProtocolDiff extends Logging {
  ...
  val fields: Set[String] =
    allFields[ModuleProtocol].foldLeft(Set.empty[String]) {
      case (acc, prop) =>
  ...
  def diff(
    ...
    fields.foldLeft(
      ...
      def go[A](
          lens: Lens[ModuleProtocol, A],
          lens2: Lens[ModuleOutput, A]
      ) =
      ...
      field match {
        ...
        case "metadata.lecturers" =>
          go(
            GenLens[ModuleProtocol].apply(_.metadata.lecturers),
            GenLens[ModuleOutput].apply(_.metadata.lecturers)
          )
        case "metadata.moduleManagement" =>
          go(
            GenLens[ModuleProtocol].apply(
        ...
        case "metadata.moduleRelation" =>
          go(
            ...
            GenLens[ModuleOutput].apply(_.metadata.moduleRelation)
          )
        case "metadata.participants" =>
          go(
            GenLens[ModuleProtocol].apply(
        ...
        case "metadata.location" =>
          go(
            GenLens[ModuleProtocol].apply(_.metadata.location),
            GenLens[ModuleOutput].apply(_.metadata.location)
          )
        case "metadata.status" =>
          go(
            GenLens[ModuleProtocol].apply(_.metadata.status),
            GenLens[ModuleOutput].apply(_.metadata.status)
          )
        case "metadata.workload.projectWork" =>
          go(
            GenLens[ModuleProtocol].apply(
        ...
        case "metadata.season" =>
          go(
            GenLens[ModuleProtocol].apply(_.metadata.season),
            GenLens[ModuleOutput].apply(_.metadata.season)
          )
        case "metadata.duration" =>
          go(
            GenLens[ModuleProtocol].apply(_.metadata.duration),
            GenLens[ModuleOutput].apply(_.metadata.duration)
          )
        case "metadata.language" =>
          go(
            GenLens[ModuleProtocol].apply(_.metadata.language),
            GenLens[ModuleOutput].apply(_.metadata.language)
          )
        case "metadata.ects" =>
          go(
            GenLens[ModuleProtocol].apply(_.metadata.ects),
            GenLens[ModuleOutput].apply(_.metadata.ects)
          )
        case "metadata.moduleType" =>
          go(
            GenLens[ModuleProtocol].apply(_.metadata.moduleType),
            GenLens[ModuleOutput].apply(_.metadata.moduleType)
          )
        case "metadata.abbrev" =>
          go(
            GenLens[ModuleProtocol].apply(_.metadata.abbrev),
            GenLens[ModuleOutput].apply(_.metadata.abbrev)
          )
        case "metadata.title" =>
          go(
            GenLens[ModuleProtocol].apply(_.metadata.title),
            GenLens[ModuleOutput].apply(_.metadata.title)
          )
        case other =>
          logger.error(s"unsupported key: $other")
          (existing, existingUpdatedKeys)
